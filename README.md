...
A curated landing page with extended abstracts is also available on [Academia.edu](https://uba.academia.edu/METorresPonce) and [ResearchGate](https://www.researchgate.net/profile/Mariano-Torres-Ponce).
...
- **Parallel version**: [SSRN](http://dx.doi.org/10.2139/ssrn.5687822)
...
- **Supplementary material**: Supplementary explanatory video providing a narrative overview of the paper’s core arguments. [(Watch video)](https://archive.org/download/zenodo.17363577/TorresPonce_2023_SRE_Law_of_Technological_Risk_Explanatory_Video.mp4)
...
- **Citation evidence (PDF extract)**: [Download](citations/2022-deteccion-delitos-extract.pdf)
